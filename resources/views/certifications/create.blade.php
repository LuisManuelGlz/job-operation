...
@section('title') Create certification @endsection

@section('content')

<h2 class="font-bold text-5xl text-blue-400 mb-10">Create certification</h2>

<form class="w-1/2" action="{{ route('certifications.store') }}" method="post">
  @csrf()
  ...
  <div class="mt-5">
    <input
      ...
      value="{{ old('has_an_expiration_date') }}"
      autocomplete="off"
      checked>
